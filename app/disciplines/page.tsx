    ...
    <SitePage>
      <section className="hero split-hero disciplines-hero">
        <div className="container hero-grid">
          ...
          <div className="hero-image frame-offset"><img src="/assets/disciplines-hero.avif" alt="A focused researcher reviewing printed academic journals by a large library window, soft natural daylight, shallow depth of field, 35mm lens" /></div>
        </div>
      </section>
      ...
      <section className="disciplines-section soft-gray" id="fields">
        <div className="container">
          ...
          <div className="discipline-layout">
            <article className="discipline-card wide"><div><h3>Physical Sciences &amp; Engineering</h3><p>Expert manuscript refinement for physics, chemistry, materials science, and all engineering branches. We focus on methodological clarity and mathematical precision.</p></div><img src="/assets/formal-sciences.avif" alt="Close-up of a researcher working on a complex mathematical model on a laptop in a bright, modern laboratory, clean cool-toned indoor lighting" /></article>
            ...
            <article className="discipline-card wide reverse"><img src="/assets/journals.avif" alt="Neatly stacked academic journals and books on a clean wooden desk, soft natural library daylight, shallow depth of field" /><div><h3>Formal Sciences</h3><p>Specialized support for computer science, mathematics, and statistics, ensuring precise notation, algorithm formatting, and clean code presentation.</p></div></article>
          </div>
        </div>
      </section>
